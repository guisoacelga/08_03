public class PrimValidationDemo3 {
    ...
    public static boolean isPrim(int number) {       //se pasa como parámetro el nro q vamos a chequear si es o no primo
        ...
        while(counter < Math.sqrt(number)) {        //Mientras el contador sea menor que la raíz cuadrada del nro
                                                    //raíz cuadrada del nro xq a esas alturas ya se sabe si habrá divisor
